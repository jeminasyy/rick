            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card card-body border rounded-10 bg-white mb-3 p-6">
                        <p class="font-weight-bold h3">Total Tickets</p>
                        <p class="cardinfo">4</p>
                        <a href="/" class="text-primary">View</a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card card-body border rounded-10 bg-white mb-3 p-6">
                        <p class="font-weight-bold h3">New Tickets</p>
                        <p class="cardinfo">4</p>
                        <a href="/" class="text-primary">View</a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card card-body border rounded-10 bg-white mb-3 p-6">
                        <p class="font-weight-bold h3">Resolved Tickets</p>
                        <p class="cardinfo">4</p>
                        <a href="/" class="text-primary">View</a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card card-body border rounded-10 bg-white mb-3 p-6" >
                        <p class="font-weight-bold h3">Reopened Tickets</p>
                        <p class="cardinfo">4</p>
                        <a href="/" class="text-primary">View</a>
                    </div>
                </div>
