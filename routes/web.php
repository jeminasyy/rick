...
Route::get('/categories/archived', [CategController::class, 'archived'])->middleware('auth');
...
// Archive Category
Route::get('/categories/{id}/archive', [CategController::class, 'archive'])->middleware('auth');
// Unarchive Category
Route::get('/categories/{id}/unarchive', [CategController::class, 'unarchive'])->middleware('auth');
// Delete Category
...
// Delete User
Route::delete('/users/{user}/archive', [UserController::class, 'destroy'])->middleware('auth');
// Restore User
Route::get('/users/restore/{id}', [UserController::class, 'restore'])->middleware('auth');
